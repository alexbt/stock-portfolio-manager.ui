...
public abstract class AbstractAddTransactionPanel extends JPanel {
	...
	public AbstractAddTransactionPanel() {
		...
		typeField.setEditor(new ComboBoxModelEditor());
		typeField.setRenderer(new ComboBoxModelRenderer());
												...
												groupLayout
														...
														.addGroup(
																groupLayout
																																		...
																																		.addGroup(
																																				groupLayout
																																						.createParallelGroup(
																																								Alignment.LEADING)
																																						.addComponent(
																																								reinvestQuantityLabel)
																																						.addComponent(
																																								reinvestQuantityField,
																																								GroupLayout.PREFERRED_SIZE,
																																								GroupLayout.DEFAULT_SIZE,
																																								GroupLayout.PREFERRED_SIZE)))
																														.addGroup(
																		...
																		.addGap(20))
														.addGroup(
																groupLayout.createSequentialGroup().addComponent(addButton).addGap(18)
																		.addComponent(addCloseButton).addGap(18).addComponent(closeButton)
																		.addGap(86)))
										.addGroup(
												groupLayout.createParallelGroup(Alignment.LEADING, false).addComponent(tagsLabel)
														.addComponent(sectorLabel).addComponent(sectorField, 0, 218, Short.MAX_VALUE)
														.addComponent(labelsList, 0, 0, Short.MAX_VALUE)).addGap(40)));
		groupLayout
				.setVerticalGroup(groupLayout
						...
						.addGroup(
								groupLayout
												...
												groupLayout
														...
														.addGroup(
																groupLayout
																		...
																		.addComponent(dateLabel))
														.addComponent(currencyLabel, GroupLayout.PREFERRED_SIZE, 18,
																GroupLayout.PREFERRED_SIZE))
										.addGap(5)
										.addGroup(
												groupLayout
														.createParallelGroup(Alignment.LEADING)
														.addComponent(sectorField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(currencyField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(symbolField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
																GroupLayout.PREFERRED_SIZE))
										.addGap(24)
										.addGroup(
												groupLayout
														...
														.addGroup(
																groupLayout.createParallelGroup(Alignment.BASELINE)
																		...
																		.addComponent(commisionLabel).addComponent(totalLabel)
																		.addComponent(tagsLabel)).addComponent(typeLabel))
										...
										.addGap(12))
						.addGroup(
								groupLayout.createSequentialGroup().addGap(38)
										.addComponent(dateField, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
										.addContainerGap(211, Short.MAX_VALUE))
						.addGroup(
								groupLayout.createSequentialGroup().addGap(38)
										.addComponent(nameField, GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE).addGap(211)));
		groupLayout.linkSize(SwingConstants.VERTICAL, new Component[] { dateLabel, symbolLabel, companyNameLabel, priceLabel,
				quantityLabel, currencyLabel, commisionLabel, totalLabel, typeLabel, tagsLabel, reinvestLabel, reinvestPriceLabel,
				reinvestQuantityLabel, reinvestTotalLabel, sectorLabel });
		groupLayout.linkSize(SwingConstants.VERTICAL, new Component[] { currencyField, typeField, symbolField, sectorField });
		groupLayout.linkSize(SwingConstants.VERTICAL, new Component[] { dateField, priceField, commissionField, totalField, quantityField,
				reinvestPriceField, reinvestQuantityField, reinvestTotalField });
