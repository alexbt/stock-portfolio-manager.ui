...
public class PerformanceSymbolModel extends AbstractTableModel {
	...
	public static final String[] COLUMN_NAMES = { "Symbol", "Total Cost Basis", "Mkt Value", "Mkt Growth (%)", "Capital Gain", "Dividend",
			"Dividend (%)", "Overall Return (%)", "Annual Rate Monthly Compound (%)" };
	 ...
	 * @return The corresponding field of the contracotr at the specified row
	 *         and column.
	 * @see Contractor
	 */
