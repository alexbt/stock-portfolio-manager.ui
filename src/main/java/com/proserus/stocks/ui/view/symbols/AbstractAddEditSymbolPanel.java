...
public abstract class AbstractAddEditSymbolPanel extends JPanel {
	...
	public AbstractAddEditSymbolPanel() {
												...
												groupLayout
																				...
																				groupLayout
																						...
																						.addGroup(
																								groupLayout
																										...
																										.addComponent(currencyField, 0,
																												105, Short.MAX_VALUE)
																										.addComponent(symbolField, 0, 0,
																												Short.MAX_VALUE))
														...
														.addGroup(
																groupLayout
																		.createSequentialGroup()
																		.addGap(72)
																		.addComponent(addButton, GroupLayout.PREFERRED_SIZE, 101,
																				GroupLayout.PREFERRED_SIZE)
																		.addPreferredGap(ComponentPlacement.RELATED)
																		.addComponent(addCloseButton)
																		.addPreferredGap(ComponentPlacement.RELATED)
																		.addComponent(closeButton, GroupLayout.PREFERRED_SIZE, 101,
												...
												groupLayout
														...
														.addGroup(
																groupLayout.createParallelGroup(Alignment.BASELINE)
																		.addComponent(symbolLabel).addComponent(companyNameLabel)))
										.addGroup(
												groupLayout
														.createSequentialGroup()
														.addGap(32)
														.addGroup(
																groupLayout
																		...
																		.addComponent(symbolField, GroupLayout.PREFERRED_SIZE, 26,
																				GroupLayout.PREFERRED_SIZE)
																		.addComponent(companyNameField, GroupLayout.PREFERRED_SIZE, 26,
																				GroupLayout.PREFERRED_SIZE))))
						.addGap(18)
						.addGroup(
								groupLayout
										...
										.addGroup(
												groupLayout
														...
														.addGap(11))
										.addGroup(
												groupLayout.createSequentialGroup().addComponent(useCustomPricesLabel).addGap(9)
														.addComponent(useCustomPriceField)))
						.addPreferredGap(ComponentPlacement.RELATED, 11, Short.MAX_VALUE)
						.addGroup(
								groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(addButton).addComponent(addCloseButton)
		...
		groupLayout.linkSize(SwingConstants.VERTICAL, new Component[] { symbolLabel, companyNameLabel, currencyLabel, useCustomPricesLabel,
				sectorLabel });
