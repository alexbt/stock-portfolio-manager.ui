				...
				groupLayout
						...
						.addGroup(
								groupLayout
										...
										.addComponent(labelList, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addGroup(
												Alignment.LEADING,
												groupLayout
														...
														.addGroup(
																groupLayout
																		...
																		.addComponent(yearField, GroupLayout.PREFERRED_SIZE, 105,
														...
														.addGroup(
																groupLayout
																		...
																		.addComponent(symbolField, GroupLayout.PREFERRED_SIZE, 115,
																				GroupLayout.PREFERRED_SIZE))
														.addGap(18)
														.addGroup(
																groupLayout
																		...
																		.addComponent(transactionTypeField, GroupLayout.PREFERRED_SIZE,
																				127, GroupLayout.PREFERRED_SIZE))
														.addGap(18)
														.addGroup(
																groupLayout
																		.createParallelGroup(Alignment.LEADING)
																		.addComponent(currencyField, GroupLayout.PREFERRED_SIZE, 97,
																				GroupLayout.PREFERRED_SIZE)
																		.addComponent(currencyLabel, GroupLayout.PREFERRED_SIZE, 64,
																				GroupLayout.PREFERRED_SIZE))
														.addGap(18)
														.addGroup(
																groupLayout
																		.createParallelGroup(Alignment.LEADING)
																		.addComponent(sectorLabel, GroupLayout.PREFERRED_SIZE, 64,
																				GroupLayout.PREFERRED_SIZE)
																		.addComponent(sectorField, GroupLayout.PREFERRED_SIZE, 218,
								...
								groupLayout
										...
										.addGroup(
												groupLayout
														.createSequentialGroup()
														.addGroup(
																groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(yearLabel)
																		.addComponent(transactionTypeLabel).addComponent(symbolLabel))
														...
														.addGroup(
																groupLayout
																		...
																		.addComponent(symbolField, GroupLayout.PREFERRED_SIZE,
																				GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
																		.addComponent(transactionTypeField, GroupLayout.PREFERRED_SIZE,
																				GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
										.addGroup(
												groupLayout
														...
														.addGroup(
																groupLayout.createParallelGroup(Alignment.BASELINE)
																		.addComponent(currencyLabel).addComponent(sectorLabel))
														.addPreferredGap(ComponentPlacement.RELATED)
														.addGroup(
																groupLayout
																		.createParallelGroup(Alignment.BASELINE)
																		.addComponent(currencyField, GroupLayout.PREFERRED_SIZE,
																				GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
																		.addComponent(sectorField, GroupLayout.PREFERRED_SIZE,
																				GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))))
						.addContainerGap()));
